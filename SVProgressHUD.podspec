Pod::Spec.new do |s|
  s.name     = 'SVProgressHUD+kern'
  s.version  = '2.1.4'
  s.ios.deployment_target = '8.0'
  s.tvos.deployment_target = '9.0'
  s.license  =  { :type => 'MIT', :file => 'LICENSE.txt' }
  s.summary  = 'A clean and lightweight progress HUD for your iOS and tvOS app.'
  s.homepage = 'https://github.com/slimski/SVProgressHUD'
  s.authors   = { 'Sam Vermette' => 'hello@samvermette.com', 'Tobias Tiemerding' => 'tobias@tiemerding.com', 'Igor Nabokov' => 'slimski@gmail.com' }
  s.source   = { :git => 'https://github.com/slimski/SVProgressHUD.git', :tag => s.version.to_s }
